...
static const char* TAG = "TheBoard";
...
TheBoard::TheBoard(void) : Board()
{
    configuration = new Configuration();
}

TheBoard::~TheBoard(void)
{
...
esp_err_t TheBoard::EarlyInit(void)
{
    // onboard "button"
...
esp_err_t TheBoard::CriticalInit(void)
{
    return ESP_OK;
}

esp_err_t TheBoard::BoardInit(void)
{
...
esp_err_t TheBoard::PostInit(void)
{
...
bool TheBoard::PowerPeripherals(bool turnOn)
{
    gpio_set_level(GPIO_Power, turnOn ? 1 : 0);
    return true;
}

esp_err_t TheBoard::StartTheServers(void)
{
...
void TheBoard::StopTheServers(void)
{
    httpServer.StopServer();
}

esp_err_t TheBoard::ConfigureMDNS(void)
{
...
bool TheBoard::OnboardButtonPressed(void)
{
    return (gpio_get_level(GPIO_BOOT) == 0) ? true : false;
}

QueueHandle_t TheBoard::GetHttpServerQueue(void)
{
    return httpServer.GetQueueHandle();
}

void TheBoard::RefreshSystemState(bool printResult)
{
